...
/**
 * FormalExamId entity. @author MyEclipse Persistence Tools
 */

public class FormalExamId implements java.io.Serializable {
	...
	/** full constructor */
	public FormalExamId(String number, Date ccfTime) {
		this.number = number;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof FormalExamId))
			return false;
		FormalExamId castOther = (FormalExamId) other;
